import 'package:app_ilmu_tajwid/pages/makharijul_page.dart';
...
class GridContainer extends StatelessWidget {
  ...
  const GridContainer(this.color, this.image, this.titleText);
